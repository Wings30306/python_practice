...
class TestBoggle(unittest.TestCase):
  ...
  def test_grid_size_is_width_times_height(self):
    """
    Test is to ensure that the total size of the grid is equal to width * heyght
    """
  ...
  def test_grid_is_filled_with_letters(self):
    """
    Test to ensure that each of the coordinates inside of the grid contains a letter
    """
    grid = boggle.make_grid(2,3)
  ...
  def test_all_grid_neighbours(self):
    """
    Test to ensure that all of the grid positions have neighbours
    """
    grid = boggle.make_grid(2,2)
  ...
  def test_converting_a_path_to_a_word(self):
    """
    Test to ensure that paths can be converted to words
    """
    grid = boggle.make_grid(2,2)
  ...
  def test_search_grid_for_words(self):
    """
    Test to ensure certain patterns can be found in a path_to_word
    """
